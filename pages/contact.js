...
//   TO-DO: Setup Sendgrid API for email handling on client-side, and Vercel for CI/CD and hosting

  export default function Contact() {
    const { hasCopied, onCopy } = useClipboard('justinalvin98@gmail.com');
